...
Continuando con la reflexión anterior, es importante mencionar como se ha conseguido la síntesis del sonido, y el guardado del mismo.\\


\subsection{\textbf{$f(x)= sin(2\pi x)$}, $g(x)=0$}
(CAMBIAR PARA QUE SEA ACORDE AL SONIDO)
