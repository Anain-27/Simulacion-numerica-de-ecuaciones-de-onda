...
En nuestro caso trabajaremos sobre $L^2(E)$, que será un espacio de Hilbert, que es un espacio de Hilbert con el siguiente producto interior.
...
\end{definicion}
El producto interior discreto, no tiene porque ser definido expresamente un un mallado, pero, ya que este será el contexto en el que lo utilizaremos a lo largo de el trabajo, es conveniente definirlo sobre el mismo.\\
