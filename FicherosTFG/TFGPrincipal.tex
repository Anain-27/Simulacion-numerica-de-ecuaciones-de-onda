...
% ----------------------------------------------------------------------
    ...
    \pdfinfo { /Title  (TFG)
               /Creator (TeX)
               /Producer (pdfTeX)
               /Author (Ana Cuevas de Cózar)  %%%%%%%%% XXX    Nombre y apellidos
               /CreationDate (D:DDMMYYYhhmmss)  %format D:YYYYMMDDhhmmss
               /ModDate (D:DDMMYYYhhmm)
               /Subject (TFG)  %%%%%%%%% XXX   Tema
               /Keywords (keyword1, keyword2, keyword3) }  %%%%%%%%% XXX  claves del trabajo
    \pdfcatalog { /PageMode (/UseOutlines)
                  /OpenAction (fitbh)  }


\crest{\includegraphics[width=3cm]{SelloUCA.jpg}}


% ---------------------------------------------        RELLENA CON TUS DATOS
\title{Simulación numérica de ecuaciones de onda.} %%%%% XXX   Nombre del trabajo
\author{\LARGE Ana Cuevas de Cózar}    %%%    XXX Nombre y apellidos alumno/a
\textadvisor{Tutores: }          %%% XXX  Poner tutor o tutora según proceda
\advisor{Dr.José Rafael Rodríguez Galvan}  %%% XXX  Nombre del tutor o tutora
\advisortwo{D.Daniel Acosta Soba}                  %%% XXX  Nombre del 2º tutor si lo hay
\textsignaturecandidate{Firma de la alumna}   %%% XXX  Poner alumno o alumna según proceda
\textsignatureadvisor{Firma de los tutores}    %%% XXX  Poner tutor o tutora según proceda
\cityofbirth{Puerto Real, Cádiz}
\degreedate{Junio de 2.023}
% ----------------------------------------------------------------------
