...
\begin{itemize}
	...
	Veamos cual es la condición necesaria para que se de $(1)$,
	 ...
	 \begin{equation}\label{mu}
	 	\mu\leq 1.
	 \end{equation}
	 llegamos que para que el esquema sea estable necesitamos que se de esta última condición $\mu\leq 1$, la condición CFL.		
\end{itemize}
...
Con esto ya podríamos implementar cada una de las soluciones, para ver como se comportan las mismas a comparación de $u$.
...
\begin{equation}\label{deltaxx}
	\begin{split}
		\left<\delta_t u_{\cdot,r},\delta_{xx}u_{\cdot,r}\right>'_D &\underset{\ref{derivada2}}{=} \left<\delta_t u_{\cdot,r},\delta_{x^+x^-}u_{\cdot,r}\right>'_D\\
