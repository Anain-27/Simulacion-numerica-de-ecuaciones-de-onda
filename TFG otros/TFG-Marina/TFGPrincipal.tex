...
\crest{\includegraphics[width=2.5cm]{SelloUCA.jpg}}


% ---------------------------------------------        RELLENA CON TUS DATOS
\title{Problemas de clasificación multiclases con SVM} %%%%% XXX   Nombre del trabajo
\author{\LARGE Marina Aquino del Valle}    %%%    XXX Nombre y apellidos alumno/a
...
\textsignatureadvisor{Firma de la tutora}    %%% XXX  Poner tutor o tutora según proceda
\cityofbirth{Puerto Real, Cádiz}
\degreedate{Julio de 2.022}
% ----------------------------------------------------------------------
...
%\bibliographystyle{unrst} % Defines the bibliography style
